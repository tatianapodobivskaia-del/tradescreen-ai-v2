...
import { User, GraduationCap, Linkedin, Github, BookOpen, MapPin, Shield, ExternalLink } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <motion.div custom={0} initial="hidden" animate="visible" variants={fadeIn}>
        ...
        <p className="text-base text-slate-500 font-body mt-2 leading-relaxed">
          Background, credentials, and research focus behind TradeScreenAI
        </p>
      </motion.div>
          ...
          <div className="p-8">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-base text-slate-500 font-body mt-1">Sanctions Compliance Researcher & Developer</p>
      ...
      <motion.div custom={5} initial="hidden" animate="visible" variants={fadeIn}>
        <div className="rounded-xl border border-amber-200/60 bg-amber-50/50 p-6">
          <p className="text-sm text-amber-700 font-body leading-relaxed">
            <span className="font-semibold">Academic Disclaimer:</span> TradeScreen AI is an academic research prototype developed at Atlantis University (ISM 6026). For educational use only — not a commercial compliance tool. This system is not a substitute for professional legal or compliance advice.
          </p>
        </div>
      </motion.div>
    </div>
